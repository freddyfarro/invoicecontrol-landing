...
const REPLY_TO = 'info@getinvoicecontrol.com';
...
const LANGS = {
  es: {
    ...
    footerText: 'InvoiceControl · info@getinvoicecontrol.com · España',
  ...
  en: {
    ...
    eu: 'EU servers',
    footerText: 'InvoiceControl · info@getinvoicecontrol.com · Spain',
  ...
  pt: {
    ...
    enc: 'Cifrado AES-256',
    eu: 'Servidores na UE',
    footerText: 'InvoiceControl · info@getinvoicecontrol.com · Espanha',
  ...
  fr: {
    ...
    footerText: 'InvoiceControl · info@getinvoicecontrol.com · Espagne',
